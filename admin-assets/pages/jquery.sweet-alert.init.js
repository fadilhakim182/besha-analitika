...
!function ($) {
    ...
    SweetAlert.prototype.init = function () {
        ...
        $('#sa-success-product').click(function () {
            swal("Good job!", "Product Successful Added", "success")
        });


        $('#sa-success-slider').click(function () {
            swal("Good job!", "Slider Successful Added", "success")
        });
        ...
        $('.delete-slider').on("click", function(e) {
            ...
            function(isConfirm) {if (isConfirm) {window.location.replace(url);} else { swal("Oke", "Take your time", "error");}
            });
        ...
        $('.delete-manu').on("click", function(e) {
